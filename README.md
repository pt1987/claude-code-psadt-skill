...
- **A dossier is produced every time**, uploaded or not: one self-contained bilingual HTML file with the
  ...
  description.
- **738 Pester tests**, including drift guards that fail when the documentation and the code disagree -
...
verified against a live tenant. The helper scripts are covered by 738 Pester tests.
